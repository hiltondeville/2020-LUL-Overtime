...
<html>
  ...
  <div class="top-margin jumbotron">
    ...
    <p class="lead">Figures are based on HMRC tax codes for 2018/19. Individual circumstances and volume of overtime undertaken over the year may affect the accuracy of the results. Please use as a guide only.</p>
    <hr class="m-y-2">
...
if(isset($_POST['overtime'])) {
  ...
  if (strtoupper($sloanScheme1) === "YES") {
    if($scheme1 >= 1410) {
      $scheme1result = floor(($scheme1 - 1410) / 100 * 9);
  ...
  if (strtoupper($sloanScheme2) === "YES") {
    if($scheme2 >= 1923.07) {
      $scheme2result = floor(($scheme2 - 1923.07) / 100 * 9);
