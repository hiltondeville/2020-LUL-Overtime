...
<html>
  ...
  <div class="top-margin jumbotron">
    <h1 class="display-3"><h2>London Underground operational employee after tax overtime calculator</h2></h1>
...
if(isset($_POST['Id'])) {
  ...
  ?>
 <div class="well">
<form class="" action="ot.php" method="post">
...
<form class="form" action="ot.php" method="post">
